            ...
            match selection:
                case '1':
                    ...
                    if(diescore == 1):
                        ...
                        {diescore + playerRoundTotal}, Throw again or stop round?""")
                        print("---------------------------------------------------------------------------------")
            ...
            match selection:
                case '1':
                    ...
                    if(diescore == 1):
                        ...
                        print(f"""your roll: {diescore}, added to your round total of:
                        {diescore + player2RoundTotal}, Throw again or stop round?""")
                        print("""----------------------------------------------------
                        -----------------------------""")
...
def print_rolles_endgame(diePlayer, dieCpu):
    ...
    {diePlayer.show_amount_rolls()} times""")
    print(f"""Computer has thrown the dice
    {dieCpu.show_amount_rolls()} times""")
...
def print_rolles_endgame_1vs1(diePlayer, dieplayer2):
    ...
    {dieplayer2.show_amount_rolls()} times""")
